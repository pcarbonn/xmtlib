...
Groundings:
 ...
 - (not (Edge x y)):
    ...
    F: SELECT Edge_TU.a_0 AS x, Edge_TU.a_1 AS y, not_(Edge_TU.G) AS G FROM Edge_TU AS Edge_TU
 ...
 - (not (Edge y z)):
    ...
    F: SELECT Edge_TU_4.a_0 AS y, Edge_TU_4.a_1 AS z, not_(Edge_TU_4.G) AS G FROM Edge_TU AS Edge_TU_4
 ...
 - (not (Edge x z)):
    ...
    F: SELECT Edge_TU_7.a_0 AS x, Edge_TU_7.a_1 AS z, not_(Edge_TU_7.G) AS G FROM Edge_TU AS Edge_TU_7
 ...
 - (or (not (Edge x y)) (not (Edge y z)) (not (Edge x z)) (phi x y z)):
    ...
    UF: SELECT Edge_TU.a_0 AS x, Edge_TU.a_1 AS y, Edge_TU_4.a_1 AS z, or_(not_(Edge_TU.G), not_(Edge_TU_4.G), not_(Edge_TU_7.G), apply("phi", Edge_TU.a_0, Edge_TU.a_1, Edge_TU_4.a_1)) AS G FROM Edge_TU AS Edge_TU JOIN Edge_TU AS Edge_TU_4 ON Edge_TU.a_1 = Edge_TU_4.a_0 JOIN Edge_TU AS Edge_TU_7 ON Edge_TU.a_0 = Edge_TU_7.a_0 AND Edge_TU_4.a_1 = Edge_TU_7.a_1
