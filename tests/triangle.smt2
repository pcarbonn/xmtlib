...
(pop)
(assert (or (not true) (not true) (not true) (phi |1| |2| |3|)))
(assert (or (not true) (not true) (not true) (phi |1| |2| |3|)))
(assert (or (not true) (not true) (not true) (phi |1| |2| |3|)))
(assert (or (not true) (not true) (not true) (phi |1| |2| |3|)))
(assert (or (not true) (not true) (not true) (phi |1| |2| |3|)))
...
Groundings:
 ...
 - (not (Edge x y)):
    TU: SELECT Edge_UF.a_0 AS x, Edge_UF.a_1 AS y, apply("not", Edge_UF.G) AS G FROM Edge_UF AS Edge_UF
    UF: SELECT Edge_TU.a_0 AS x, Edge_TU.a_1 AS y, apply("not", Edge_TU.G) AS G FROM Edge_TU AS Edge_TU
 ...
 - (not (Edge y z)):
    TU: SELECT Edge_UF_4.a_0 AS y, Edge_UF_4.a_1 AS z, apply("not", Edge_UF_4.G) AS G FROM Edge_UF AS Edge_UF_4
    UF: SELECT Edge_TU_4.a_0 AS y, Edge_TU_4.a_1 AS z, apply("not", Edge_TU_4.G) AS G FROM Edge_TU AS Edge_TU_4
 ...
 - (not (Edge x z)):
    TU: SELECT Edge_UF_7.a_0 AS x, Edge_UF_7.a_1 AS z, apply("not", Edge_UF_7.G) AS G FROM Edge_UF AS Edge_UF_7
    UF: SELECT Edge_TU_7.a_0 AS x, Edge_TU_7.a_1 AS z, apply("not", Edge_TU_7.G) AS G FROM Edge_TU AS Edge_TU_7
 ...
 - (or (not (Edge x y)) (not (Edge y z)) (not (Edge x z)) (phi x y z)):
    TU: SELECT Edge_G.a_0 AS x, Edge_G.a_1 AS y, Edge_G_4.a_1 AS z, apply("or", apply("not", Edge_G.G), apply("not", Edge_G_4.G), apply("not", Edge_G_7.G), apply("phi", Edge_G.a_0, Edge_G.a_1, Edge_G_4.a_1)) AS G FROM Node JOIN Node AS Node_1 JOIN Node AS Node_4
    UF: SELECT Edge_TU.a_0 AS x, Edge_TU.a_1 AS y, Edge_TU_4.a_1 AS z, apply("or", apply("not", Edge_TU.G), apply("not", Edge_TU_4.G), apply("not", Edge_TU_7.G), apply("phi", Edge_TU.a_0, Edge_TU.a_1, Edge_TU_4.a_1)) AS G FROM Node JOIN Node AS Node_1 JOIN Node AS Node_4 JOIN Edge_TU AS Edge_TU JOIN Edge_TU AS Edge_TU_4 ON Edge_TU.a_1 = Edge_TU_4.a_0 JOIN Edge_TU AS Edge_TU_7 ON Edge_TU.a_0 = Edge_TU_7.a_0 AND Edge_TU_4.a_1 = Edge_TU_7.a_1
    G : SELECT Edge_G.a_0 AS x, Edge_G.a_1 AS y, Edge_G_4.a_1 AS z, apply("or", apply("not", Edge_G.G), apply("not", Edge_G_4.G), apply("not", Edge_G_7.G), apply("phi", Edge_G.a_0, Edge_G.a_1, Edge_G_4.a_1)) AS G FROM Node JOIN Node AS Node_1 JOIN Node AS Node_4 JOIN Edge_G AS Edge_G JOIN Edge_G AS Edge_G_4 ON Edge_G.a_1 = Edge_G_4.a_0 JOIN Edge_G AS Edge_G_7 ON Edge_G.a_0 = Edge_G_7.a_0 AND Edge_G_4.a_1 = Edge_G_7.a_1
