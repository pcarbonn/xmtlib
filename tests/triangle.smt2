...
Groundings:
 ...
 - (Edge x x):
    TU: SELECT Edge_TU_12.a_1 AS x, Edge_TU_12.G AS G FROM Edge_TU AS Edge_TU_12 WHERE Edge_TU_12.a_1 = Edge_TU_12.a_0
    UF: SELECT Edge_UF_12.a_1 AS x, Edge_UF_12.G AS G FROM Edge_UF AS Edge_UF_12 WHERE Edge_UF_12.a_1 = Edge_UF_12.a_0
